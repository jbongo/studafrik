@include('admin.layout.topmenu')
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Catégorie des articles</h1>
                  <hr>
                                ...
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$categorie->nom}}</td>
                                            <td>    
                                                <a data-toggle="modal" data-target="#exampleModalCenter2" href="#" url="{{route('admin.categorie_article.update', Crypt::encrypt($categorie->id))}}" class="btn btn-success btn-circle btn-sm  update" nom="{{$categorie->nom}}"><i class="fas fa-edit"></i></a>     

                                            <a href="{{route('admin.categorie_article.delete', Crypt::encrypt($categorie->id))}}" class="btn btn-danger btn-circle btn-sm supprimer"><i class="fas fa-trash"></i></a></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" action="{{route('admin.categorie_article.store')}}">
...
<script>
    ...
    $(function() {
        ...
        $('body').on('click','a.supprimer',function(e) {
            ...
            //     title: 'Confirmez-vous la suppression de cette article ?',
            //     type: 'warning',
            //     showCancelButton: true,
            //     confirmButtonColor: '#DD6B55',
            //     confirmButtonText: '@lang('Oui')',
            ...
            //         swalWithBootstrapButtons(
            //         'Annulé',
            //         'L\'article n\'a pas été supprimée.',
