        ...
        <div class="container">
             <div class="row">
                 <div class="col-lg-12" style="margin-top: 60px; margin-bottom: 100px">
                    ...
                    <h3 style="text-align: center;"><strong>Gestion de mon compte</strong></h3>
                    <h4><strong><span style="color: #ff6600;">Comment puis-je me cr&eacute;er un compte Stud&rsquo;Afrik ? 🤔</span></strong></h4>
                    <p><span style="font-weight: 400;">D&eacute;j&agrave;, bienvenue :)&nbsp;</span></p>
                    
                    

Nous vous invitons à lire avec attention le présent document (ci-après, la « Politique de Confidentialité » ou les « Règles de Confidentialité »). Pour toute question concernant ce document et, d’une manière générale, sur la collecte et le traitement de vos informations personnelles par la société Stud’Afrik, n’hésitez pas à nous contacter via l’adresse e-mail suivante : contact@studafrik.com

Préambule et champ d’application

La société Stud’Afrik est soucieuse de préserver la confidentialité de vos informations personnelles et attache une grande importance à la protection de la vie privée des utilisateurs de ses services.
...
La Politique de Confidentialité fait partie intégrante des Conditions générales d’utilisation et de vente du site Studafrik.com. Elle s’applique aux utilisateurs de notre site quelle que soit leur catégorie : particulier, non-professionnel, professionnel, candidat ou encore recruteur.
Nos Règles de Confidentialité ne s’appliquent pas aux services proposés par des sociétés tierces, exploitant des sites web partenaires de la société Stud’Afrik ou d’autres sites web accessibles à partir de nos services. Nous ne sommes pas responsables de la façon dont ces sites utilisent vos Données Personnelles.

Acceptation et mise à jour de nos Règles de Confidentialité

En cochant en ligne la case “J’ai lu et j’accepte la Politique de Confidentialité du site Studafrik.com”, vous (en qualité d’Utilisateur) confirmez avoir pris connaissance et accepter sans restriction ni réserve les présentes. Si vous êtes en désaccord avec l’un de ses termes, vous êtes libre de ne pas ou ne plus utiliser nos services (en cas de modification des termes de la Politique).
Nos Règles de Confidentialité peuvent être amenées à changer, étant précisé que toute diminution de vos droits ne saurait être appliquée sans votre consentement. Aussi, nous publierons les nouvelles versions de la Politique de Confidentialité sur le site Studafrik.com et nous vous alerterons au moyen d’un email vous offrant la possibilité de les consulter.
D’une manière générale, la Politique de Confidentialité est toujours facilement accessible via les différentes pages du site Studafrik.com.
Responsable de traitement des Données Personnelles

Le traitement des Données Personnelles des Utilisateurs inscrits au site Studafrik.com est soumis à la loi française, notamment à la loi n° 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, modifiée (dite Loi Informatique et Libertés).
Le « responsable de traitement », tel que défini par ladite Loi, des Données Personnelles des Utilisateurs du site Studafrik.com est : Société Stud’Afrik - RCS XX - ADRESSE.
...
Enfin, nous vous informons que le traitement des Données Personnelles des Utilisateurs du site Studafrik.com a dûment été déclaré à la Commission Nationale Informatique et Libertés (dite ‘CNIL’), sous le numéro 1811611.

4. Catégories de Données Personnelles collectées et traitées via le site Studafrik.com

Données personnelles que vous communiquez à la société Stud’Afrik

Nous collectons les Données Personnelles des internautes qui souhaitent : en savoir plus sur nos activités (via le formulaire de contact), recevoir nos actualités, postuler aux offres d’emploi mis en ligne sur le site Studafrik.com et acheter des services sur notre site (formulaires d’inscription et réservations de coaching ou formations).
L’accès et l’utilisation du site Studafrik.com impliquent la collecte et le traitement de vos Données Personnelles, à savoir notamment le nom, prénom, numéro de téléphone, adresses e-mail et postale, CV, photographie, etc. Certaines informations sont obligatoires (suivi d’un astérisque) et d’autres facultatives comme indiqué dans le formulaire.

Cookies

Un « cookie » (ou « traceur ») est un témoin de connexion qui désigne un fichier texte susceptible d’être enregistré dans un espace dédié du disque dur de votre terminal (ordinateur, tablette, ou smartphone), à l’occasion de la consultation d’un service accessible en ligne. Un cookie permet à son émetteur d’identifier le terminal dans lequel il est enregistré, pendant la durée de validité ou d’enregistrement du cookie. Le cookie ne permet donc pas de vous identifier en tant que tel ; il sert à enregistrer vos informations de navigation sur le site Studafrik.com.
Lors de vos visites sur le site Studafrik.com, des informations relatives à votre navigation sont susceptibles d’être enregistrées dans des fichiers “Cookies” installés sur votre terminal, sous réserve des choix que vous aurez exprimés concernant les cookies et que vous pouvez modifier à tout moment. Ces cookies permettent une navigation personnalisée de l’Utilisateur et sont également utilisés à des fins analytiques (mesures d’audience).
Vous serez averti de l’existence des cookies et de leur(s) finalité(s) dès votre connexion au site Studafrik.com, par la présence d’un bandeau d’information placé en bas ou en haut de la page d’accueil.
...
Absence de communication au tiers
...
Faire appliquer la Politique de Confidentialité et les Conditions générale de vente du site Studafrik.com en vigueur, y compris pour constater d’éventuels manquements à celles-ci ;
Se prémunir contre toute atteinte aux droits, aux biens ou à la sécurité de la société Stud’Afrik et de ses utilisateurs, en application et dans le respect de la loi.
...
Par e-mail à : contact@studafrik.com
