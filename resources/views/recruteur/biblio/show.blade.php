                     ...
                     <div class="job-single-sec style3">
                                 ...
                                 <div class="col-lg-9" style="margin-top: 8px">
                                     <div class="job-single-head3 emplye">
                                         ...
                                         <div class="job-single-info3"> 
                                             <h3>{{$recruteur->raison_sociale}}</h3>
                         ...
                         <div class="job-wide-devider">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                  <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Offres d'emplois</a>
                                </li>
                                 ...
                                 <div class="col-lg-4 column">
                                     <div class="job-overview">
                                         ...
                                         <ul>
                                             ...
                                             <li><i class="la la-file-text"></i><h3>Nombre d'offres</h3><span>{{sizeof($recruteur->mes_offres)}}</span></li>
                                             <li><i class="la la-bars"></i><h3>Secteur d'activité</h3><span>{{$recruteur->categorie}}</span></li>
                                             <li><i class="la la-users"></i><h3>Taille de l'entreprise</h3><span>{{$recruteur->nb_salarie}}</span></li>
